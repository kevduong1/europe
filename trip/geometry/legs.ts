import { densify, greatCircle, joinLines, lineLengthKm, type LngLat } from "@/lib/engine/geo";
...
import type { OvernightStop, PhotoPin, StopCluster } from "@/lib/engine/types";
...
export const localRoutes: Record<string, LngLat[]> = {
