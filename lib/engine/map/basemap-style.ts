...
import { INK, LAGOON, MUTED, PAPER } from "../palette";

export const TERRAIN_SOURCE_ID = "journey-terrain";
export const TERRAIN_HILLSHADE_SOURCE_ID = "journey-hillshade-dem";
export const TERRAIN_HILLSHADE_LAYER_ID = "journey-hillshade";

/**
 * Public, keyless elevation tiles. Mapterhorn's TileJSON includes its required
 * attribution and chooses its best available open DEM for each region.
 */
