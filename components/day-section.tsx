  ...
  return (
    ...
    >
      ...
      <div className="mx-auto w-full max-w-[640px] px-6 pb-[max(2rem,env(safe-area-inset-bottom))]">
        <div ref={headRef} className="day-head">
        ...
        <p className="beat-copy overlay-type mt-3 max-w-[32em] text-[16px] leading-relaxed text-[var(--ink)]">
          {day.summary}
        </p>
          ...
          <ul className="mt-8 space-y-2">
            {day.practical.map((item) => (
              <li
                key={item.text}
                className={cn(
                  "beat-copy overlay-type text-[15px] leading-relaxed",
